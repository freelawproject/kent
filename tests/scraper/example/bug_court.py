...
court where insects file civil lawsuits. It exercises the framework's main
features:

- A simple function that parses HTML and yields dicts.
- A class with multiple methods, yielding ParsedData and Request.
